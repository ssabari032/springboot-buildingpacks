insert into user values(101, 'Chennai', 'kreddy@stacksimplify.com', 'Kalyan', 'Reddy', 'admin', 'ssn101', 'kreddy');
insert into user values(102, 'Chennai', 'gwiser@stacksimplify.com', 'Greg', 'Wiser', 'admin', 'ssn102', 'gwiser');
insert into user values(103, 'Chennai', 'dmark@stacksimplify.com', 'David', 'Mark', 'admin', 'ssn103', 'dmark');
